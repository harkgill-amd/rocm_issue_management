 ...
 * @param {String} summary Title of ticket taken directly from the GitHub issue
 ...
 * @returns String
 */
function createSWDEVTicketBody(program, summary, description, gpuLabel, rocmLabel){
...
/**
 * Extracts each portion of the GitHub Issue and returns an object with all portions
...
function extractInfoFromIssueBody(body){
    ...
    const delims = [descriptionDelim, osDelim, cpuDelim, gpuDelim, otherGpuDelim, rocmVersionDelim, rocmComponent, stepsDelim, rocmInfoDelim, additionalInfoDelim]
...
extractInfoFromIssueBody(sample2)